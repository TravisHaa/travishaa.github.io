...
const experiences: Experience[] = [
  {
    ...
    shortDescription: 'Leading design systems and building component libraries for modern web applications',
    details: [
  ...
  },
  {
    ...
    shortDescription: 'Developed interactive web experiences with focus on performance and accessibility',
    details: [
  ...
  },
  {
    ...
    shortDescription: 'Researching human-computer interaction and designing novel interaction techniques',
    details: [
          ...
          >
            ...
            <div className="p-10">
              ...
              <div className="flex items-start gap-6 mb-4">
                {/* Company Logo */}
                <div className="flex-shrink-0 w-20 h-20 rounded-xl overflow-hidden bg-white">
                  <ImageWithFallback
                    src={exp.logo}
                ...
                <div className="flex-1">
                  <div className="mb-3 text-xl font-semibold">{exp.company}</div>
                  <div className="text-base text-black/60 mb-2">{exp.role}</div>
                  <div className="text-sm text-black/40">{exp.date}</div>
                </div>
                <motion.div
              ...
              {/* Short Description */}
              <p className="text-base text-black/70">{exp.shortDescription}</p>
                ...
                {expandedId === exp.id && (
                  ...
                  >
                    ...
                    >
                      {/* Details */}
                      <div className="mb-8">
                        <div className="text-base font-medium mb-4 text-black/80">What I did</div>
                        <ul className="space-y-3">
                          {exp.details.map((detail, i) => (
                            <li key={i} className="text-base text-black/60 pl-5 relative before:content-['•'] before:absolute before:left-0 before:text-black/30">
                              {detail}
                            </li>
                          ))}
                        </ul>
                      ...
                      {/* Tech Stack */}
                      <div className="mb-6">
                        <div className="text-base font-medium mb-4 text-black/80">Tech Stack</div>
                        <div className="flex flex-wrap gap-3">
                          {exp.techStack.map((tech) => (
                            <span
                              key={tech}
                              className="px-4 py-2 rounded-full bg-white/60 text-sm text-black/70"
                              style={{
                      ...
                      {/* Impact */}
                      {exp.impact && (
                        <div className="text-base text-black/50 italic">
                          {exp.impact}
                        </div>
                      )}
                    </motion.div>
